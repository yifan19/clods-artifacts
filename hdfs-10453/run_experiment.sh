...
# deploys the vendored hadoop-2.5.2 + hbase-1.2.5 + zookeeper-3.4.6, formats/starts it, runs the
# baseline YCSB-vs-HBase workload, then for each round in [1 2 3 4] injects that round's instrumentation
...
MISSING=0
[ -f ../binaries/hadoop-2.5.2.tar.gz ] || { echo "[MISSING] binaries/hadoop-2.5.2.tar.gz (needed: hadoop_name=hadoop-2.5.2)" >&2; MISSING=1; }
