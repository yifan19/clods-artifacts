...
# deploys the vendored hadoop-0.20.2 + hbase-0.91.0-hbase3627 + zookeeper-3.2.2, formats/starts it, runs the
# baseline YCSB-vs-HBase (legacy) workload, then for each round in [1 2 3 4] injects that round's instrumentation
...
[ -f ../binaries/hbase-0.91.0-hbase3627.tar.gz ] || { echo "[MISSING] binaries/hbase-0.91.0-hbase3627.tar.gz (needed: hbase_name=hbase-0.91.0-hbase3627)" >&2; MISSING=1; }
