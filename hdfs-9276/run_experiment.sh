...
# deploys the vendored hadoop-2.8.1-SNAPSHOT + hbase-1.2.5, formats/starts it, runs the
...
MISSING=0
[ -f ../binaries/hadoop-2.8.1-SNAPSHOT.tar.gz ] || { echo "[MISSING] binaries/hadoop-2.8.1-SNAPSHOT.tar.gz (needed: hadoop_name=hadoop-2.8.1-SNAPSHOT)" >&2; MISSING=1; }
